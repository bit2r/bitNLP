...
#| fig.alt: >
#|   Shiny 앱의 데이터 탭에서는 분석하고자 하는 데이터 셋의 변수 이름과 데이터 유형을 확인할 수 있습니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 검색/대체 탭에서는 데이터 셋에서 조건 변수를 대상으로 키워드를 입력하여, 조건변수에 키워드가 포함된 문서를 검색하는 UI/UX를 제공합니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 검색/대체 탭에서는 데이터 셋에서 조건변수에 키워드가 포함된 문서를 검색한 후 우측 결과에 해당 문장을 출력하고, 검출된 키워드를 붉은색으로 표시합니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 검색/대체 탭에서는 데이터 셋에서 조건변수에 키워드가 포함된 문서들을 전후로 패치하여 조회하는 UI/UX 기능을 제공합니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 대체는 데이터 셋에서 조건변수에 패턴 검색을 수행한 후 대체 패턴 문장으로 변경하는 UI/UX 기능을 제공합니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 형태소를 이용한 검색은  패턴 검색의 결과를 추출하는 문서를 원문과 형태소 단위로 이원화 출력해줍니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 공동발생분석 탭 메뉴는 공통으로 발현하는 문장을 명사 단위로 추출하여 출력해줍니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 N-Gram 탭 메뉴는 문장을 명사 단위로 N-Gram 추출하여 출력해줍니다.
...
```{r, echo=FALSE, out.width='95%', fig.align='center', fig.pos="!h"}
#| fig.alt: >
#|   Shiny 앱의 R Command 탭 메뉴는 R 명령어를 수행할 수 있는 기능을 제공합니다.
